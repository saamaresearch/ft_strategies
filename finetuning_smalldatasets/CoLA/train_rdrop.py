...
parser.add_argument('--rdropalpha', type=float, default=1.0, help="set the coefficient for rdropout [0.1,0.5,1.0]")
    ...
    def train(epoch):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
            ...
            *inputs, targets = batch
            ...
            ce_loss = 0.5 * (loss_fn(outputs1, targets) + loss_fn(outputs2, targets))

            kl_loss = compute_kl_loss(outputs1, outputs2)

            # carefully choose hyper-parameters
            loss = ce_loss + args.rdropalpha * kl_loss
